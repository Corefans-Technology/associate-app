<template>
  ...
  >
    <!-- navigations -->
    <ul
      class="w-full px-6 md:px-10 xl:px-[4rem] mx-auto flex items-center space-x-8 text-[#626E8B] font-medium text-base"
    >
      <!-- logo -->
      <li class="flex-none">
        <app-link to="/">
      ...
      <!-- About Us -->
      <li v-show="!isAuthenticated" class="flex-none hidden lg:block">
        <app-link to="https://demo.corefans.co/about"> About Us </app-link>
      </li>
      <!-- Explore -->
      <li v-show="!isAuthenticated" class="flex-none hidden lg:block">
        <app-link to="https://demo.corefans.co/explore"> Explore </app-link>
      </li>
      <li v-show="!isAuthenticated" class="flex-none hidden lg:block">
        <app-link to="https://demo.corefans.co/explore"> Contact </app-link>
      </li>
      ...
      >
        <app-link
          ...
          >Start a campaign</app-link
        >
      </li>
      <!-- Log in -->
      <li v-show="!isAuthenticated" class="flex-none hidden lg:block">
        <app-link :to="{ name: 'login' }"> Log in </app-link>
      </li>
      <!-- Sign up -->
      <li v-show="!isAuthenticated" class="flex-none hidden lg:block">
        <app-link :to="{ name: 'sign.up' }"> Sign up </app-link>
      </li>
      ...
      <li v-if="isAuthenticated" class="flex-none hidden lg:block">
          ...
          <div>
            ...
            >
              ...
              <div class="text-right">
                ...
                <p class="text-xs font-normal text-grey-1">
